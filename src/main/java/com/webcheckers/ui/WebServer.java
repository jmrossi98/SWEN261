...
public class  WebServer {
  ...
  public static final String SIGNIN_ACCOUNT_URL = "/signinAccount";
  public static final String SIGNOUT_URL = "/signout";
  public static final String SIGNIN_ERROR = "ErrorMsg";
  public static final String SIGNIN_VALID_NAME = "Valid";
  public static final String SIGNIN_INVALID_NAME = "No \"Quote\" or Empty Name Allowed. Please Try Again.";
  public static final String SIGNIN_NAME_ALREADY_IN_USE = "Name Already In Use. Please Try Again.";
  public static final String GAME_START_URL = "/gamestart";
  ...
  public static final String GAME_ENDED = "GameEnd";
  public static final String GAME_WINNER = "GameWinner";
  public static final String GAME_WIN_MODE = "GameWinMode";
  public static final String BACKUP_MOVE = "/backupMove";
  public static final String GAME_RESIGN = "/resignGame";
  /**
   * The URL Pattern to request the BoardView page.
   */
  ...
  public void initialize() {
    ...
    get(SIGNIN_ACCOUNT_URL, new GetSigninAccountRoute(templateEngine));
    get(SIGNOUT_URL, new GetSignoutRoute(playerLobby, templateEngine));
    post(GAME_START_URL, new PostGamestartRoute(templateEngine, playerLobby));
    post(SIGNIN_URL, new PostSigninRoute(playerLobby, templateEngine));
    post(SIGNIN_ACCOUNT_URL, new PostSigninAccountRoute(playerLobby, templateEngine));
    ...
    post(BACKUP_MOVE, new PostBackupTurnRoute(gson, playerLobby));
    post(GAME_RESIGN, new PostResignGameRoute(gson, playerLobby));

    //
    LOG.config("WebServer is initialized.");

    /* Uncomment to pre-load four players in for testing purposes.
    */
    playerLobby.addPlayer("John");
    playerLobby.addPlayer("Jack");
    playerLobby.addPlayer("Grace");
    playerLobby.addPlayer("Jane");
